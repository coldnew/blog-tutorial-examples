...
var m__6812__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__6811__auto__)]);
if(!((m__6812__auto__ == null))){
return m__6812__auto__.call(null,this$);
} else {
var m__6812__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__6811__auto__ = (((this$ == null))?null:this$);
var m__6812__auto__ = (hickory.core.as_hickory[goog.typeOf(x__6811__auto__)]);
if(!((m__6812__auto__ == null))){
return m__6812__auto__.call(null,this$);
} else {
var m__6812__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__6812__auto____$1 == null))){
return m__6812__auto____$1.call(null,this$);
} else {
...
var pred__12185 = cljs.core._EQ_;
var expr__12186 = (this$["nodeType"]);
if(cljs.core.truth_(pred__12185.call(null,hickory.core.Attribute,expr__12186))){
...
var expr__12189 = (this$["nodeType"]);
if(cljs.core.truth_(pred__12188.call(null,hickory.core.Attribute,expr__12189))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__12188.call(null,hickory.core.Comment,expr__12189))){
...
if(cljs.core.truth_(pred__12188.call(null,hickory.core.Document,expr__12189))){
...
if(cljs.core.truth_(pred__12188.call(null,hickory.core.DocumentType,expr__12189))){
...
if(cljs.core.truth_(pred__12188.call(null,hickory.core.Element,expr__12189))){
...
if(cljs.core.truth_(pred__12188.call(null,hickory.core.Text,expr__12189))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__12189)].join('')));
}
}
}
}
...
var temp__4657__auto__ = cljs.core.second.call(null,(function (){var or__6156__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var temp__4657__auto___12191 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4657__auto___12191)){
var title_el_12192 = temp__4657__auto___12191;
if(cljs.core.empty_QMARK_.call(null,(title_el_12192["text"]))){
hickory.core.remove_el.call(null,title_el_12192);
} else {
}
} else {
}
...
var or__6156__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__6156__auto__)){
return or__6156__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1456413334599